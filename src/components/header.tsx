  ...
  return (
    <header className="flex items-center justify-between h-16 px-4 border border-border rounded-xl mt-8 bg-transparent backdrop-blur-2xl">
      ...
      <div className="flex items-center space-x-4">
        <Link href="/">
          <button className="size-8 rounded-xl flex items-center justify-center cursor-pointer text-muted-foreground hover:bg-muted/10 hover:text-foreground transition-colors">
